...
questions_data = [
    ...
    ("American Literature", "It is possible for authors to write under pen names.", "True/False", "", "True", "You are correct as Authors can indeed write under pen names.", "Incorrect. The statement is true and that authors can write under pen names."),
    ("American Literature", "Shakespeare is known for his contributions to American Literature.", "True/False", "", "False", "You are correct! Shakespeare is not known for his contributions to American Literature.", "Incorrect. The statement is false as he is not known for his contributions to American Literature."),
    # Category 3
    ...
    ("Database Management", "A database administrator manages data but does not deal with database security.", "True/False", "", "False", "You are Correct! A database administrator also deals with database security.", "Incorrect. A database administrator deals with the security of a database."),
    ("Database Management", "In a relational database, each table can have only one primary key.", "True/False", "", "True", "Correct! Each table in a relational database can have only one primary key.", "Incorrect. Each table can only have one primary key."),
    # Category 4
